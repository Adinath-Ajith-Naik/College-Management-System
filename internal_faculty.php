    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-20 mx-auto">
            ...
            <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    $sql="select * from internals where subjects = '".$user_data['faculty_subject']."' ";
        ...
        <div class="container px-48 py-18 mx-auto">
            <div class="flex flex-wrap text-center">
                ...
                onclick=""><a href="internals_delete.php">Delete</a></button>
                <button
                class="flex mx-auto mb-10 text-white bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg"
                onclick=""><a href="internals_update.php">Update</a></button>
                <button
                class="flex mx-auto mb-10 text-white bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg"
                onclick=""><a href="internal_add.php">Add</a></button>
            </div>
          </div>

        <button
            class="flex mx-auto mb-10 text-white bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg"
            ><a href="index_faculty.php">Go Back</a></button>
