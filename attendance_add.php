...
if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($student_name) && !empty($attendance))
		{
			...
			//save to database
			$query = "insert into attendance (user_name,subjects,attendance) values ('".$student_name."','".$user_data['faculty_subject']."',".$attendance.")";
        ...
        <form method="POST">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Insert Attendance </h1>
                </div>
