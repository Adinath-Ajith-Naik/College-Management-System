...
session_start();
   ...
   {
        $sql = "insert into assignment (user_name,subjects,topic,due) values ('".$student_name."','".$user_data['faculty_subject']."','".$topic."','".$originalDate."')";
        ...
        <form method="POST">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Assignment Form</h1>
                </div>
