...
if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($student_name))
		{
			...
			//save to database
			$query = "delete from internals where user_name='".$student_name."' and subjects='".$user_data['faculty_subject']."'";
    ...
    <form method="POST">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Delete Internals</h1>
            </div>
            ...
            <div class="flex w-full justify-center items-end">
                <button
                    ...
                    <button
                    class="flex mx-auto mb-10 text-white bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-red-700 rounded text-lg mt-8"
                    onclick="" ><a href="internal_faculty.php">Go Back</a></button>
