...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($student_name) && !empty($attendance))
		{
			...
			//save to database
			$query = "delete from attendance where user_name = '".$student_name."' and subjects = '".$user_data['faculty_subject']."'";
    ...
    <form method="POST">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Delete Attendance</h1>
            </div>
