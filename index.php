    ...
    <header class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <button
                ...
                onclick=""><a href="logout.php">Logout</a>
    ...
    <section class="text-gray-400 bg-gray-900 body-font h-15">
        <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-white mb-4">MBCET Student Portal
                </h1>
                <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Welcome <?php echo $user_data['user_name']; ?> </p>
            </div>
            <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                ...
                <!-- <div class="p-2 sm:w-1/2 w-full">
                    <a href="assignment_form.php">
                        <div class="bg-gray-800 rounded flex p-4 h-full items-center">

                            <span class="title-font font-medium text-white">Course Register</span>
                        </div>
                    </a>
                </div> -->
            </div>
